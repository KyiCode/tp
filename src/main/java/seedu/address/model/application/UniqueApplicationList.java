 ...
 * An application is considered unique by comparing using
 * {@code Application#isSameApplication(Application)}. As such, adding and updating of
 * applications uses Application#isSameApplication(Application) for equality so as to ensure
 * that the application being added or updated is unique in terms of identity in the
...
public class UniqueApplicationList implements Iterable<Application> {
     ...
     * existing application in the list.
     */
