...
public class TypicalApplications {
    ...
    public static final Application BENSON_WITH_REMINDER_INTERVIEW = new ApplicationBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com")
            .withPhone("98765432")
            .withDate("2024-02-20")
    ...
    public static final Application HENSON_WITH_REMINDER_INTERVIEW_TODAY =
            new ApplicationBuilder().withName("Henson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com")
            .withPhone("98765432")
            .withDate("2024-02-20")
    ...
    public static final Application CARL = new ApplicationBuilder().withName("Carl Kurz")
            .withPhone("95352563")
    ...
    public static final Application DANIEL = new ApplicationBuilder().withName("Daniel Meier")
            .withPhone("87652533")
    ...
    public static final Application ELLE = new ApplicationBuilder().withName("Elle Meyer")
            .withPhone("9482224")
    ...
    public static final Application FIONA = new ApplicationBuilder().withName("Fiona Kunz")
            .withPhone("9482427")
    ...
    public static final Application GEORGE = new ApplicationBuilder().withName("George Best")
            .withPhone("9482442")
    ...
    // Manually added
    public static final Application HOON = new ApplicationBuilder().withName("Hoon Meier")
            .withPhone("8482424")
    ...
    public static final Application IDA = new ApplicationBuilder().withName("Ida Mueller")
            .withPhone("8482131")
    ...
    public static List<Application> getTypicalApplications() {
        return new ArrayList<>(Arrays.asList(
                ALICE, BENSON_WITH_REMINDER_INTERVIEW, CARL, DANIEL, ELLE, FIONA, GEORGE));
    }
}
